...
type Querier interface {
	...
	CountUserQuestionsInGroup(ctx context.Context, arg CountUserQuestionsInGroupParams) (int64, error)
	...
	GetGroupAllQuestions(ctx context.Context, arg GetGroupAllQuestionsParams) ([]Question, error)
	...
	GetNonVotersByseason(ctx context.Context, arg GetNonVotersByseasonParams) ([]string, error)
	...
	GetTopAttributeAllTime(ctx context.Context, arg GetTopAttributeAllTimeParams) (GetTopAttributeAllTimeRow, error)
	...
	GetTopVotedCategoryBySeason(ctx context.Context, seasonID string) (QuestionCategory, error)
	...
	GetUsersWithStreakInGroup(ctx context.Context, arg GetUsersWithStreakInGroupParams) ([]string, error)
	GetVotedUsersBySeason(ctx context.Context, seasonID string) ([]string, error)
